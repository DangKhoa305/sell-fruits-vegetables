...
public class ProductDAO {
    ...
    private static final String SHOW = "SELECT productID,productName,image,price,quantity,categoryID,importDate, usingDate, status FROM tblProduct WHERE productName like ? AND usingDate >= ? ";
